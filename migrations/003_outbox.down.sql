...
ALTER TABLE messages ALTER COLUMN price TYPE NUMERIC(12,4) USING (price::NUMERIC / 100000);
ALTER TABLE messages ALTER COLUMN cost TYPE NUMERIC(12,4) USING (cost::NUMERIC / 100000);
